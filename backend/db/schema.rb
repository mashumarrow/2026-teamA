...
ActiveRecord::Schema[7.0].define(version: 2026_07_15_000000) do
  ...
  create_table "portal_photos", force: :cascade do |t|
    ...
    t.index ["user_id", "category", "created_at"], name: "index_portal_photos_on_user_id_and_category_and_created_at"

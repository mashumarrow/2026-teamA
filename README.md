...
1. IC カードをかざすと、入退室ログが記録されて滞在時間ダッシュボードに反映されます。
2. 3D の研究室画面から、音楽・写真・滞在時間・カード再登録へ移動できます。
3. Spotify でお気に入り曲を登録し、ルーレット抽選から実際に曲を再生できます。
4. 「研究室に来る」「滞在する」「音楽が流れる」という実際の行動が、ひとつの体験としてつながっています。
